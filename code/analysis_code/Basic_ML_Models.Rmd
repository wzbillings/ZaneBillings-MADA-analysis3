...
For the random forest we can probably use the same tuning routine as we did for the decision tree, but I'll increase the size of the grid of parameters to search.
