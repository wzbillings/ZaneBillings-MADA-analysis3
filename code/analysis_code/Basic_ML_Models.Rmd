...
# improve in 10 consecutive runs. I've also lowered the cooling coefficient
# a bit and increased the neighborhood to search.
rf_sa <- rf_wf %>%
  tune_sim_anneal(
    resamples = resamples,
    metrics = bt_met,
...
For the final step of this analysis, we need to choose one of the models. {EXPLAIN HERE}
